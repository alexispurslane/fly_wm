...
var (
	...
	canvasWidth, canvasHeight = 300, 70

	// The background color of the canvas.
	bg = xgraphics.BGRA{B: 0x21, G: 0x21, R: 0x21, A: 0xff}
...
func main() {
	...
	_, _, err = ximg.Text(10, 10+firsth, fg, size+8, font, "   [2/4] 2: [Terminal] [Firefox]")
	if err != nil {
		log.Fatal(err)
	}
	...
	// to update.
	secw, sech := xgraphics.Extents(font, size, "   [2/4] 2: [Terminal] [Firefox]")
